...
from hydroe2e.phase2.controllers.multi_objective_mpc import MultiObjectiveMPC, OptimizationWeights
from hydroe2e.phase2.controllers.feedforward_control import FeedforwardController, IntegratedFeedforwardMPC
from hydroe2e.phase2.topology.network_topology import (
...
class TestFeedforwardControl(unittest.TestCase):
    ...
    def test_feedforward_computation(self):
        """测试前馈计算"""
        from hydroe2e.phase2.controllers.feedforward_control import DisturbanceForecast
