...
class TestOPCUAAdapter:
    ...
    def test_connection_config_creation(self):
        """测试连接配置创建"""
        from hydroe2e.phase5.data_interface.opc_ua_adapter import OPCUAConnectionConfig, OPCUASecurityMode
    ...
    def test_node_creation(self):
        """测试节点创建"""
        from hydroe2e.phase5.data_interface.opc_ua_adapter import OPCUANode, OPCUADataType, OPCUANodeClass
    ...
    def test_adapter_connect_disconnect(self):
        """测试适配器连接和断开"""
        from hydroe2e.phase5.data_interface.opc_ua_adapter import OPCUAAdapter, OPCUAConnectionConfig
    ...
    def test_register_node(self):
        """测试节点注册"""
        from hydroe2e.phase5.data_interface.opc_ua_adapter import (
...
class TestModbusAdapter:
    ...
    def test_device_config_creation(self):
        """测试设备配置创建"""
        from hydroe2e.phase5.data_interface.modbus_adapter import ModbusDeviceConfig, ModbusByteOrder
    ...
    def test_register_creation(self):
        """测试寄存器创建"""
        from hydroe2e.phase5.data_interface.modbus_adapter import (
    ...
    def test_adapter_connect_disconnect(self):
        """测试适配器连接断开"""
        from hydroe2e.phase5.data_interface.modbus_adapter import ModbusAdapter, ModbusDeviceConfig
...
class TestSCADAInterface:
    ...
    def test_tag_creation(self):
        """测试标签创建"""
        from hydroe2e.phase5.data_interface.scada_interface import (
    ...
    def test_tag_engineering_conversion(self):
        """测试工程单位转换"""
        from hydroe2e.phase5.data_interface.scada_interface import SCADATag
    ...
    def test_tag_alarm_check(self):
        """测试报警检查"""
        from hydroe2e.phase5.data_interface.scada_interface import SCADATag, SCADAAlarmState
    ...
    def test_create_water_network_tags(self):
        """测试创建水网标签"""
        from hydroe2e.phase5.data_interface.scada_interface import SCADAInterface
    ...
    def test_export_import_configuration(self):
        """测试配置导出导入"""
        from hydroe2e.phase5.data_interface.scada_interface import SCADAInterface, SCADATag
...
class TestDataReplayEngine:
    ...
    def test_create_session(self):
        """测试创建会话"""
        from hydroe2e.phase5.data_interface.data_replay import (
    ...
    def test_statistics(self):
        """测试统计信息"""
        from hydroe2e.phase5.data_interface.data_replay import DataReplayEngine
...
class TestModuleImports:
    ...
    def test_import_all_components(self):
        """测试导入所有组件"""
        from hydroe2e.phase5.data_interface import (
            # OPC-UA
            OPCUAAdapter,
            OPCUANode,
            OPCUASubscription,
