...
# Phase 3: 数字孪生
try:
    from hydroe2e.digital_twin.physics.single_channel_fidelity import SingleChannelFidelity
...
# Phase 4: 智能决策与自愈
try:
    from hydroe2e.phase4.anomaly_detection.ensemble_detector import EnsembleDetector
