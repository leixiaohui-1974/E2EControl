...
def test_all_module_imports():
    ...
    for module_name, classes in modules:
        try:
            module = __import__(f'hydroe2e.phase5.water_transfer_system.{module_name}', fromlist=classes)
...
def test_closed_loop_integration():
    ...
    print("\n测试9.4: IDZ物理模型...")
    try:
        from hydroe2e.phase5.water_transfer_system.physics_model import IDZModel, IDZParameters
