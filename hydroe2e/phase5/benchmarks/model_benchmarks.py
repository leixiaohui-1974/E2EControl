...
def benchmark_scenario_vae(
    ...
    测试VAE编码、解码和采样性能。
    """
    from hydroe2e.phase5.ai_models.scenario_vae import ScenarioVAEConfig, ScenarioVAE
...
def benchmark_environment(
    ...
    测试环境step和reset性能。
    """
    from hydroe2e.phase5.ai_models.water_canal_env import WaterCanalEnvConfig, OneGateTwoPoolsEnv
