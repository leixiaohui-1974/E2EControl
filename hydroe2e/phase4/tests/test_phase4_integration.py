...
class TestAnomalyDetectionBase(unittest.TestCase):
    ...
    def test_anomaly_types(self):
        """测试异常类型枚举"""
        from hydroe2e.phase4.anomaly_detection.base_detector import AnomalyType, SeverityLevel
    ...
    def test_severity_levels(self):
        """测试严重程度枚举"""
        from hydroe2e.phase4.anomaly_detection.base_detector import SeverityLevel
    ...
    def test_anomaly_report_creation(self):
        """测试异常报告数据类"""
        from hydroe2e.phase4.anomaly_detection.base_detector import (
    ...
    def test_calculate_severity(self):
        """测试严重程度计算"""
        from hydroe2e.phase4.anomaly_detection.base_detector import calculate_severity, SeverityLevel
    ...
    def test_adaptive_threshold(self):
        """测试自适应阈值"""
        from hydroe2e.phase4.anomaly_detection.base_detector import adaptive_threshold
...
class TestStatisticalDetectors(unittest.TestCase):
    ...
    def test_cusum_detector(self):
        """测试CUSUM检测器"""
        from hydroe2e.phase4.anomaly_detection.statistical_detectors import CUSUMDetector
    ...
    def test_ewma_detector(self):
        """测试EWMA检测器"""
        from hydroe2e.phase4.anomaly_detection.statistical_detectors import EWMADetector
    ...
    def test_range_detector(self):
        """测试范围检测器"""
        from hydroe2e.phase4.anomaly_detection.statistical_detectors import RangeDetector
    ...
    def test_rate_of_change_detector(self):
        """测试变化率检测器"""
        from hydroe2e.phase4.anomaly_detection.statistical_detectors import RateOfChangeDetector
...
class TestEnsembleDetector(unittest.TestCase):
    ...
    def test_ensemble_voting(self):
        """测试投票集成"""
        from hydroe2e.phase4.anomaly_detection.base_detector import EnsembleDetector
...
class TestFaultIsolation(unittest.TestCase):
    ...
    def test_component_types(self):
        """测试组件类型"""
        from hydroe2e.phase4.self_healing.isolation_strategy import ComponentType, IsolationAction
...
class TestDegradedMode(unittest.TestCase):
    ...
    def test_operation_modes(self):
        """测试运行模式"""
        from hydroe2e.phase4.self_healing.degraded_mode import OperationMode
    ...
    def test_degraded_mode_manager(self):
        """测试降级模式管理器"""
        from hydroe2e.phase4.self_healing.degraded_mode import DegradedModeManager, OperationMode
    ...
    def test_calculate_overall_health(self):
        """测试计算总体健康度"""
        from hydroe2e.phase4.self_healing.degraded_mode import DegradedModeManager
...
class TestMLDetectors(unittest.TestCase):
    ...
    def test_ml_detectors_import(self):
        """测试ML检测器导入"""
        try:
            from hydroe2e.phase4.anomaly_detection.ml_detectors import (
    ...
    def test_isolation_forest(self):
        """测试孤立森林检测器"""
        try:
            from hydroe2e.phase4.anomaly_detection.ml_detectors import IsolationForestDetector
        except ImportError:
            self.skipTest("scikit-learn未安装")
