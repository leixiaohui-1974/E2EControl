...
def neural_physics_config():
    """神经物理引擎配置"""
    from ai_models.neural_physics_engine import NeuralPhysicsConfig
...
def neural_physics_engine(neural_physics_config):
    """创建神经物理引擎实例"""
    from ai_models.neural_physics_engine import NeuralPhysicsEngine
...
def encoder_config():
    """深度场景编码器配置"""
    from ai_models.deep_scenario_encoder import DeepEncoderConfig
...
def scenario_encoder(encoder_config):
    """创建场景编码器实例"""
    from ai_models.deep_scenario_encoder import DeepScenarioEncoder
...
def vae_config():
    """场景VAE配置"""
    from ai_models.scenario_vae import ScenarioVAEConfig
...
def scenario_vae(vae_config):
    """创建场景VAE实例"""
    from ai_models.scenario_vae import ScenarioVAE
...
def env_config():
    """水渠环境配置"""
    from ai_models.water_canal_env import WaterCanalEnvConfig
...
def water_canal_env(env_config):
    """创建水渠环境实例"""
    from ai_models.water_canal_env import OneGateTwoPoolsEnv
...
def e2e_config():
    """E2E控制器配置"""
    from ai_models.l4_autonomous.e2e_controller import E2EControllerConfig
...
def e2e_controller(e2e_config):
    """创建E2E控制器实例"""
    from ai_models.l4_autonomous.e2e_controller import E2EAutonomousController
